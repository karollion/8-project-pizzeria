...

{
  ...
  class Product {
    ...
    initAccordion(){
      ...
      thisProduct.accordionTrigger.addEventListener('click', function(event) {
        ...
        thisProduct.element.classList.toggle(classNames.menuProduct.wrapperActive); //activeProduct.classNames.toogle //.classNames.toogle('active');
      });
  ...
  class Cart{
    ...
    add(menuProduct){
      ...
      const domHTML = utils.createDOMFromHTML(generatedHTML);
      /* add product to cart */
      thisCart.dom.productList.appendChild(domHTML);
    }
  }
